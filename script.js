...
(function() {
    ...
    function drawShip(ship) {
        ...
        if (ship.type === 'trek') {
            // Updated Galaxy-class (Enterprise-D) Silhouette
            ...
            ctx.closePath();
            ctx.fill();
            // Sturdier Nacelles with Red Buzzard Collectors
            ctx.fillStyle = "#4af"; // Warp Glow
            ctx.fillRect(-15, -12, 14, 4); 
            ctx.fillRect(-15, 8, 14, 4);
            ctx.fillStyle = "#f33"; // Buzzard Collectors
